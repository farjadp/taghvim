...
const SECTIONS = [
  {
    ...
    steps: [
      ...
      "بالای صفحه، کنار دکمهٔ کپی تاریخ، دکمهٔ «تصویر امروز» هست: از روزی که می‌بینی یک تصویر می‌سازد. روی گوشی پنجرهٔ هم‌رسانی باز می‌شود و روی کامپیوتر تصویر ذخیره می‌شود. تصویر در مرورگر خودت ساخته می‌شود و به جایی فرستاده نمی‌شود.",
      "پس‌زمینهٔ همان تصویر را از چرخ‌دندهٔ بالای صفحه عوض کن: پنج رنگ، یا یکی از عکس‌ها. عکس‌ها عمداً خیلی محو می‌شوند تا تاریخ و مناسبت‌ها خوانا بمانند، و انتخابت در همین مرورگر ذخیره می‌شود.",
    ],
  },
  {
    id: "events",
  ...
  },
  {
    ...
    steps: [
      "در بخش «ابزارهای تاریخ» شش زبانه هست: تعطیلات پیوسته، روزشمار، تاریخ‌های من، تبدیل تاریخ، فاصلهٔ تاریخ‌ها و محاسبهٔ سن. سه تای اول در بخش‌های بعدی همین راهنما توضیح داده شده‌اند.",
  ...
  },
  {
    ...
    steps: [
      "در بخش «ابزارهای تاریخ»، زبانهٔ «تعطیلات پیوسته» که صفحه با آن باز می‌شود، سه بازهٔ بعدی را نشان می‌دهد که با گرفتن حداکثر دو روز مرخصی به دست‌کم چهار روز تعطیلی پیوسته می‌رسند. بازه‌های بدون مرخصی هم هستند.",
      "هر روزِ بازه یک خانه است؛ خانه‌های خط‌چین روزهای مرخصی‌اند و زیر آن‌ها نام روز نوشته شده.",
      "پیوند پایین همان زبانه به صفحهٔ کامل می‌رود: بالای صفحه سال‌نماست — دوازده ماه در یک نگاه با تعطیلات، بازه‌ها و روزهای مرخصی رنگ‌شده — و زیر آن همهٔ بازه‌های امسال و سال بعد، یکی‌یکی.",
      "زبانهٔ «روزشمار» می‌گوید چند روز تا مناسبت‌های بعدی و تا نوروز و یلدا مانده. شمارش به روز است، نه به لحظه. لحظهٔ دقیق تحویل سال از اول اسفند زیر تاریخ امروز نوشته می‌شود.",
      "هر دو فقط تعطیلاتِ دسته‌های روشن را حساب می‌کنند. با پیش‌فرض، مذهبی و دولتی خاموش‌اند و بیشتر بازه‌ها نوروزند؛ کلید «مذهبی» را روشن کنی، بقیه هم می‌آیند. فقط جمعه تعطیل هفتگی حساب شده، پنجشنبه نه.",
    ],
  },
  {
    id: "dates",
    title: "تولدها و سالگردهای خودت",
    steps: [
      "در بخش «ابزارهای تاریخ»، زبانهٔ «تاریخ‌های من» را باز کن؛ عنوان و روز و ماه شمسی را بنویس و «افزودن» را بزن. سال اختیاری است، و اگر بنویسی سن یا شمارهٔ سالگرد هم نشان داده می‌شود.",
      "هر تاریخی که اضافه کنی، روی خانهٔ همان روز در تقویم صفحهٔ اصلی یک نقطهٔ سبز می‌گیرد و در راهنمای زیر تقویم هم نامش هست.",
      "دکمهٔ «افزودن به تقویم خودت» یک فایل می‌سازد که می‌توانی به تقویم گوگل یا اپل اضافه کنی. یادآوری را همان تقویم به تو می‌دهد، نه این سایت.",
      "این فهرست فقط در حافظهٔ همین مرورگر است: به هیچ سروری فرستاده نمی‌شود، بین دستگاه‌هایت همگام نمی‌شود، و با پاک کردن دادهٔ سایت از بین می‌رود. فایل خروجی هم خودش به‌روز نمی‌شود؛ تاریخ تازه که اضافه کردی، دوباره خروجی بگیر.",
    ],
  },
  {
    id: "memorial",
