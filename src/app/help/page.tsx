...
const SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      "در بخش «ابزارهای تاریخ» پنج زبانه هست: تعطیلات پیوسته، روزشمار، تبدیل تاریخ، فاصلهٔ تاریخ‌ها و محاسبهٔ سن. دو تای اول در بخش بعدی همین راهنما توضیح داده شده‌اند.",
  ...
  },
  {
    ...
    steps: [
      "در صفحهٔ «تاریخ‌های من» عنوان و روز و ماه شمسی را بنویس و «افزودن» را بزن. سال اختیاری است؛ اگر بنویسی، سن یا شمارهٔ سالگرد هم نشان داده می‌شود.",
