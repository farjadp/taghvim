...
// Why: Every continuous holiday of the year on one page. The tools box shows
//      the next three; the rest, and next year, are here.
...
export const metadata: Metadata = pageMetadata({
  title: "تعطیلات پیوسته | تقویم",
  description: "با یک یا دو روز مرخصی چند روز تعطیلی پیوسته می‌گیری؟ همهٔ بازه‌های تعطیلات پیوستهٔ سال شمسی، روز به روز، با روزهای مرخصی مشخص.",
  path: "/bridges",
});
...
export default function BridgesRoute() {
  return (
    <>
      <SiteHeader />
      <StructuredData data={breadcrumbStructuredData("تعطیلات پیوسته", "/bridges")} />
      <main className="mx-auto max-w-[1240px] px-5 pt-12 pb-16 sm:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold text-forest sm:text-4xl">تعطیلات پیوسته</h1>
