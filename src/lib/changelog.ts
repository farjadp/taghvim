...
export const UPCOMING: string[] = [
  ...
  'انتشار افزونهٔ کروم در فروشگاه کروم. خودِ افزونه از ۰.۹.۸ ساخته شده و از مخزن نصب می‌شود؛ انتشار در فروشگاه بازبینی گوگل و حساب توسعه‌دهنده می‌خواهد.',
