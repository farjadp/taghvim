...
export const UPCOMING: string[] = [
  ...
  'انتشار افزونهٔ کروم در فروشگاه کروم. افزونه ساخته شده و برای بازبینی فرستاده شده؛ منتظر تأیید گوگل است. تا آن موقع می‌شود از روی کد پروژه ساختش — راهش در صفحهٔ «دریافت تقویم» نوشته شده.',
