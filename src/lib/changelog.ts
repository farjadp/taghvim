...
export const RELEASES: Release[] = [
  {
    ...
    changes: [
      ...
      { kind: 'added', text: 'سال‌نما در همان صفحه: دوازده ماه در یک نگاه، با تعطیلات رسمی، روزهای داخل پل و روزهای مرخصی رنگ‌شده و امروز مشخص. همان کلیدهای زیر تقویم را می‌خواند.' },
