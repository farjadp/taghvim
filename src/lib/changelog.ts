...
export const RELEASES: Release[] = [
  {
    ...
    changes: [
      ...
      { kind: 'changed', text: 'مناسبت‌های دستهٔ «دولتی» دیگر نام ایران را با خود ندارند و همه با یک نشان مشخص شده‌اند. بیست‌ودوم بهمن به نام چیزی که ساخت نوشته می‌شود نه چیزی که جشن می‌گیرد، و نام بنیان‌گذارش هم عوض شده. این دسته مثل قبل به‌صورت پیش‌فرض خاموش است و در فهرست اشتراکی تقویم هم نمی‌آید.' },
    ],
  },
  {
    version: '0.9.16',
    ...
    changes: [
      { kind: 'added', text: 'زبانهٔ «تعطیلات پیوسته» در ابزارهای تاریخ، که حالا زبانهٔ پیش‌فرض است: سه بازهٔ بعدی که با حداکثر دو روز مرخصی به دست‌کم چهار روز تعطیلی پیوسته می‌رسند، به‌علاوهٔ بازه‌های بدون مرخصی. هر روزِ بازه یک خانه است و روزهای مرخصی خط‌چین‌اند.' },
      ...
      { kind: 'added', text: 'صفحهٔ «تعطیلات پیوسته» با سال‌نما — دوازده ماه در یک نگاه با تعطیلات، بازه‌ها و روزهای مرخصی رنگ‌شده — و زیر آن همهٔ بازه‌های امسال و سال بعد. زبانهٔ ابزار به آن پیوند می‌دهد.' },
      { kind: 'changed', text: 'هر دو ابزار فقط از تعطیلات دسته‌های روشن ساخته می‌شوند، پس با پیش‌فرض بیشتر بازه‌ها نوروزند. بازه‌ای که روی یک تعطیلی قمری محاسباتی بنشیند، کنار خودش می‌گوید ممکن است یک روز جابه‌جا شود.' },
    ],
  },
  {
    version: '0.9.15',
    ...
    changes: [
      ...
      { kind: 'added', text: 'افزونه برای انتشار به فروشگاه افزونه‌های فایرفاکس فرستاده شد و منتظر بازبینی موزیلا است. بررسی خودکار موزیلا بدون خطا رد شد. صفحهٔ «دریافت تقویم» حالا کارت فایرفاکس هم دارد و همان وضعیت را می‌گوید؛ وقتی تأیید شود، مثل کروم با یک ویرایش به دکمهٔ نصب تبدیل می‌شود.' },
