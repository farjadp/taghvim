...
export const RELEASES: Release[] = [
  {
    ...
    changes: [
      ...
      { kind: 'changed', text: 'هر شش زبانهٔ «ابزارهای تاریخ» حالا یک خط توضیح دارد که می‌گوید آن ابزار چه چیزی را جواب می‌دهد. پیش‌تر سه‌تایشان توضیح داشتند و سه‌تا نه.' },
      { kind: 'fixed', text: 'در «تاریخ‌های من»، اگر روز یا سال را با ارقام فارسی می‌نوشتی، تاریخ پذیرفته نمی‌شد و پیغام «تاریخ معتبر نیست» می‌گرفتی. بقیهٔ ابزارها از اول ارقام فارسی را می‌پذیرفتند؛ این یکی جا مانده بود.' },
    ],
  },
  {
    version: '0.9.20',
