...
test("the download page states each method's real status", async ({ page }) => {
  ...
  // Android is out (11 Sep): its card offers the one published APK, by its tag,
  ...
  await expect(apk).toHaveAttribute("href", "https://github.com/farjadp/taghvim/releases/download/android-v1.0/taghvim-1.0.apk");
