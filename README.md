...
تقویم‌های فارسیِ موجود شلوغ‌اند: تبلیغات، پاپ‌آپ، و ده‌ها چیزی که کسی نخواسته. تقویم فقط یک کار می‌کند و همان را درست انجام می‌دهد — نشان‌دادن روز، تاریخ و مناسبت‌ها، با هویت بصری‌ای که خجالت‌آور نباشد.
