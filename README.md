...
هیچ حسابی نمی‌سازی و هیچ داده‌ای از تو ذخیره نمی‌شود. تنها چیزی که از بیرون بارگذاری می‌شود، عکس بخش یادبود است که از CDN منبع می‌آید — و با خاموش کردن آن کلید، دیگر هیچ درخواستی به بیرون نمی‌رود. کل اپ یک صفحهٔ استاتیک با کمی محاسبهٔ سمت سرور است.
...
| **دریافت** | صفحهٔ `/download` — افزودن به صفحهٔ خانه، افزونهٔ کروم، فهرست اشتراکی؛ هر کدام با وضعیت واقعی |
